...
//   }
//
//   // Initialize the 'isLiked' state based on the 'favs' list
...
//               fontSize: 20, // You can adjust font size as needed
//             ),
//           ),
//           actions: [
//             IconButton(
...
//         body: TabBarView(
//           children: [
//             _buildTabContent(context, widget.scheme["detailed_description"] ?? ""),
//             _buildTabContent(context, widget.scheme["benefits"] ?? ""),
//             _buildTabContent(context, widget.scheme["eligibility_criteria"] ?? ""),
//             _buildTabContent(context, widget.scheme["application_process"] ?? ""),
//           ],
//         ),
//       ),
//     );
...
//               color: Colors.white,
//               fontWeight: FontWeight.bold,
//               fontSize: fontSize + 4, // Slightly larger title
//             ),
//           ),
//           actions: [
//             IconButton(
