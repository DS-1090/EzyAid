...
//   String error = "";
//   bool isSchemeLoading = true, fetched = false;
//
...
//                       context,
//                       MaterialPageRoute(
//                         builder: (context) => SchemeDetailsPage(scheme: scheme, favs: favs),
//                       ),
//                     );
//                   },
//                 ),
...
// import 'favoritespage.dart';
// import 'package:http/http.dart' as http;
// import 'text_to_speech.dart'; // <-- Import the TTS service
//
// class SchemesPage extends StatefulWidget {
//   const SchemesPage({super.key});
//
...
//
// class _SchemesPageState extends State<SchemesPage> {
//   final TextToSpeechService tts = TextToSpeechService(); // <-- Instantiate TTS service
//   bool flag = false;
//   List<String> selectedBeneficiaries = [];
//   List<String> selectedCategories = [];
//   bool showBeneficiaryDropdown = false;
...
//   @override
//   void dispose() {
//     tts.stop(); // <-- Stop TTS when leaving the page
//     super.dispose();
//   }
//
//   @override
...
//       final tags = scheme["tags"] ?? [];
//       bool matchesBeneficiary = selectedBeneficiaries.isEmpty ||
//           selectedBeneficiaries.any((beneficiary) => tags.contains(beneficiary));
//
//       bool matchesCategory = selectedCategories.isEmpty ||
//           selectedCategories.contains(scheme["category"]);
//
...
//                   },
//                   onLongPress: () async {
//                     await tts.speak(schemeName); // <-- Speak scheme name
//                   },
//                 ),
//               ),
//             );
